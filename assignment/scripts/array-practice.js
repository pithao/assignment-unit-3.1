...
let favoriteFoods = ['sushi', 'steak', 'pasta'];
...
console.log('Last animal is', lastItem);
...
console.log('Removed the last color', removeColor);
console.log(colors);

let lastColor = ['pink, green, blue']
let colorToPush = 'teal'
lastColor.push(colorToPush);
console.log('Added to new color array,', lastColor);
